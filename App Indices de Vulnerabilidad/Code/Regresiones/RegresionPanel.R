...
# print(input$provincia)
# print("Canton Seleccionado:   *************")
# print(input$region)
# print(periodos)
print(paste("Producto Numero: ",Cantones_lista[k]))
...
print("Modelo de Regresion de Panel, estimado *******************")
